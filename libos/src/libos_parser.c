...
struct parser_table {
    ...
    [__NR_setreuid] = {.slow = false, .name = "setreuid", .parser = {parse_long_arg,
                      parse_integer_arg, parse_integer_arg}},
    [__NR_setregid] = {.slow = false, .name = "setregid", .parser = {parse_long_arg,
                      parse_integer_arg, parse_integer_arg}},
    ...
    [__NR_setgroups] = {.slow = false, .name = "setgroups", .parser = {parse_long_arg,
                        parse_integer_arg, parse_pointer_arg}},
    [__NR_setresuid] = {.slow = false, .name = "setresuid", .parser = {parse_long_arg,
                      parse_integer_arg, parse_integer_arg, parse_integer_arg}},
    [__NR_getresuid] = {.slow = false, .name = "getresuid", .parser = {parse_long_arg,
                      parse_pointer_arg, parse_pointer_arg, parse_pointer_arg}},
    [__NR_setresgid] = {.slow = false, .name = "setresgid", .parser = {parse_long_arg,
                      parse_integer_arg, parse_integer_arg, parse_integer_arg}},
    [__NR_getresgid] = {.slow = false, .name = "getresgid", .parser = {parse_long_arg,
                      parse_pointer_arg, parse_pointer_arg, parse_pointer_arg}},
